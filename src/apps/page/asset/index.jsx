        ...
        <Tabs defaultActiveKey="1" onChange={this.handleTab}>
          <TabPane tab="笔记本" key="1">
            <div className="find">
              {
                asset ?
                  <RadioGroup defaultValue={asset.dftNt[0].code} size="large" onChange={this.handleSelect}>
                    <List
          ...
          <TabPane tab="台式机" key="2">
            <div className="find">
              {
                asset ?
                  <RadioGroup defaultValue={asset.dftUn[0].code} size="large" onChange={this.handleSelect}>
                    <List
                      grid={{gutter: 16, column: 3}}
              ...
              {
                asset ?
                  <RadioGroup defaultValue={asset.dftMn[0].code} size="large" onChange={this.handleSelect}>
                    <List
                      grid={{gutter: 16, column: 3}}
          ...
          <TabPane tab="一体机" key="3">
            {
              asset ?
                <RadioGroup defaultValue={asset.dftHt[0].code} size="large" onChange={this.handleSelect}>
                  <List
                    grid={{gutter: 16, column: 3}}
